...
Der MQTT Subscriber (TXT 4.0 Python Code Blöcke) teilt den Daten-String in eine Liste von Strings. Das erste Element ist eine laufende Nummer. Jede Nummer wird nur einmal verarbeitet.
